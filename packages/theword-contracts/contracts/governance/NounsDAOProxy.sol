...
/// @title The TheWord DAO proxy contract
...
// LICENSE
// thewordDAOProxy.sol is a modified version of Compound Lab's GovernorBravoDelegator.sol:
...
//
//
// thewordDAOProxy.sol uses parts of Open Zeppelin's Proxy.sol:
...
contract thewordDAOProxy is thewordDAOProxyStorage, thewordDAOEvents {
    ...
    function _setImplementation(address implementation_) public {
        require(msg.sender == admin, 'thewordDAOProxy::_setImplementation: admin only');
        require(implementation_ != address(0), 'thewordDAOProxy::_setImplementation: invalid implementation address');
