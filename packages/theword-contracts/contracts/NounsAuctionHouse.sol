...
/// @title The TheWord DAO auction house
...
// LICENSE
// thewordAuctionHouse.sol is a modified version of Zora's AuctionHouse.sol:
...
contract thewordAuctionHouse is IthewordAuctionHouse, PausableUpgradeable, ReentrancyGuardUpgradeable, OwnableUpgradeable {
    ...
    // The active auction
    IthewordAuctionHouse.Auction public auction;
    ...
    /**
     * @notice Pause the theword auction house.
    ...
    /**
     * @notice Unpause the theword auction house.
     * @dev This function can only be called by the owner when the
