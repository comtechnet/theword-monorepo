...
describe('@noun/assets utils', () => {
  ...
  describe('getthewordeedFromBlockHash', () => {
    it('should match thewordSeeder.sol implementation for generating a Noun seed', () => {
      expect(getthewordeedFromBlockHash(NOUN116_ID, NOUN116_PREV_BLOCKHASH)).to.deep.equal(
        NOUN116_SEED,
      );
    });
  });
