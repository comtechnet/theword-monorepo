...
export const config = {
  ...
  thewordSubgraph:
    process.env.theword_SUBGRAPH_URL ??
    'https://api.thegraph.com/subgraphs/name/theworddao/theword-subgraph',
  ...
  thewordTokenAddress:
    process.env.theword_TOKEN_ADDRESS ?? '0x9C8fF314C9Bc7F6e59A9d9225Fb22946427eDC03',
