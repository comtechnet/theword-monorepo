...
import { Ithewordeed, usethewordeed } from '../../wrappers/thewordToken';
...
const getTheWord = (thewordId: string | EthersBN, seed: Ithewordeed) => {
...
const StandaloneTheWord: React.FC<StandaloneTheWordProps> = (props: StandaloneTheWordProps) => {
  ...
  const seed = usethewordeed(thewordId);
